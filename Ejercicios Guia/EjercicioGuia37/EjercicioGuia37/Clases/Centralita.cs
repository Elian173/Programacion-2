...
namespace BibliotecaClases
{
    public class Centralita
    {
        ...
        public string Mostrar()
        {
            ...
            foreach (Llamada llamada in listaDeLlamadas)
            {
                if (llamada is Local) // llamada.GetType() == typeOf(Local)
                {
                    texto.Append(((Local) llamada).MostrarLocal());
                }

                if (llamada is Provincial) // llamada.GetType() == typeOf(Provincial)
                {
                    texto.Append(((Provincial) llamada).MostrarProvincial());
                }
            }
