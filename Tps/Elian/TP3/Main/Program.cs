...
namespace Main
{
    internal class Program
    {
        private static void Main( string[] args )
        {
            ...
            Alumno a1 = new Alumno(1, "noestenoesta", " EL MASCAPO", "12234456", EntidadesAbstractas.Persona.ENacionalidad.Argentino, Universidad.EClases.Programacion,Alumno.EEstadoCuenta.Becado);
            uni += a1;
            try
            {
            ...
            try
            {
                ...
                uni = Universidad.Leer();
                Console.ReadKey();
                Console.WriteLine(    uni.Jornadas[0].ToString());
                Console.ReadKey();
            }
