...
namespace ComiqueriaApp
{
    public partial class PrincipalForm : Form
    {
        ...
        private void OnVenderClick(object sender, EventArgs e)
        {
            ...
            VentasForm ventasForm = new VentasForm(this.comiqueria,this.productoSeleccionado);
        ...
        {
            ModificarProductoForm modifForm = new ModificarProductoForm(this.productoSeleccionado);
            modifForm.Show();
        }
        ...
        {
            foreach (Venta x in comiqueria.ventas)
            {
                comiqueria.AgregarComprobante(x);
                MessageBox.Show(Comiqueria.comprobantes.Peek().GenerarComprobante(), "A");
            }
